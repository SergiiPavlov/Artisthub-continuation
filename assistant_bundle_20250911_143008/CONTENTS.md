...
**size:** 4007 bytes &nbsp;&nbsp; **sha1:** `570000ab28019ba0193a2d960ede5bbddb289e2c`
...
if command -v zip >/dev/null 2>&1; then
  ...
  7z a -tzip "$ZIP" @"$OUT/_meta/include_files.list" >/dev/null
  7z a -tzip "$ZIP" "$OUT" >/dev/null
else
  echo "Нужен 'zip' или '7z' в PATH." >&2; exit 1
fi
