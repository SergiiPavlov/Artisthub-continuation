...
**size:** 5313 bytes &nbsp;&nbsp; **sha1:** `f1cf8ae437f467ef7f09e005ee2f15ca3d28eff1`
...
MAX_PER_FILE=$((200*1024))   # до 200 KB на файл в CONTENTS.md
MAX_TOTAL=$((20*1024*1024))  # до 20 MB суммарно CONTENTS.md
...
# Попытка найти 7z, даже если он не в PATH (типичные пути Windows)
SEVENZ=""
...
if command -v zip >/dev/null 2>&1; then
  ...
  "$SEVENZ" a -tzip "$ZIP" "$OUT" >/devnull
elif command -v powershell.exe >/dev/null 2>&1; then
  # Фоллбек на PowerShell (без бэктиков, чтобы Bash не путался)
