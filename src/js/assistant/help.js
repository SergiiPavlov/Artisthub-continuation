...
<div class="assistant-help__content" data-lang="uk" style="display:none">
  ...
  <ul>
    ...
    <li><code>гучніше / тихіше / без звуку</code> — змінити гучність;</li>
...
<ul>
  <li><code>знайди фільми</code>, <code>покажи фільми</code>, <code>повний фільм: комедії</code>, <code>повний фільм: За двома зайцями</code></li>
  <li><code>знайди аудіокниги</code>, <code>запропонуй аудіокниги</code>, <code>аудіокнига: «Стівен Кінг Зелена миля»</code></li>
</ul>
