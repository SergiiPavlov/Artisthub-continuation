    ...
    <div class="assistant-help__body">
      ...
      <div class="assistant-help__content" data-lang="uk">
        ...
        <ul class="assistant-help__list">
          ...
          <li><code>Гучніше</code> / <code>Тихіше</code></li>
        ...
        <ul class="assistant-help__list">
          <li><code>знайди фільми</code>, <code>повний фільм: За двома зайцями</code></li>
          <li><code>знайди аудіокниги</code>, <code>аудіокнига: «Стівен Кінг Мізері»</code></li>
        </ul>
      ...
      <div class="assistant-help__content" data-lang="ru">
        ...
        <ul class="assistant-help__list">
          ...
          <li><code>Громче</code> / <code>Тише</code></li>
        ...
        <ul class="assistant-help__list">
          <li><code>найди фильмы</code>, <code>полный фильм: «Ирония судьбы»</code></li>
          <li><code>найди аудиокниги</code>, <code>аудиокнига: «Стивен Кинг — Мизери»</code></li>
        </ul>
